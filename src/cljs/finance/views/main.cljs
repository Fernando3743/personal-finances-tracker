(ns finance.views.main
  ...
  (:require [re-frame.core :as rf]
            ...
            [finance.views.budget-analysis :as budget-analysis]
            ...
            [finance.views.budgets-panel :as budgets-panel]
  ...
  (let [active-view @(rf/subscribe [:app/current-route])]
    [:main {:class "flex-1 p-8 animate-fade-in overflow-y-auto"}
     (case active-view
       ...
       :analytics [budget-analysis/budget-analysis-view]
